                  ...
                  <Row className="pt-3 pt-sm-4 pt-lg-5 justify-content-center">
                    <Col sm={6} lg={4}>
                      <div className="dreamPlayer-shadow p-3 h-100">
                        ...
                        <p className="fw-normal ffBarlow fs-base text-black opacity-07 pt-2 pe-xl-5 pe-lg-3">
                    ...
                    <Col sm={6} lg={4} className="pt-3 pt-sm-0">
                      <div className="dreamPlayer-shadow p-3 h-100 ">
                        ...
                        <p className="fw-normal ffBarlow fs-base text-black opacity-07 pt-2 pe-xl-5 pe-lg-3 me-xl-1">
