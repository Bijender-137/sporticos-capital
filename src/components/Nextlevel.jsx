                        ...
                        <div key={index}>
                            ...
                            <Row className='d-flex justify-content-center pt-lg-3'>
                                {nextlevel.submap.map((levelsub, columnindex) => (
                                    <Col key={columnindex} lg={3} md={6} className='p-sm-0 pt-3 pt-sm-3 pt-lg-0'>
                                        <div className={`nextlevel-box ${columnindex === nextlevel.submap.length - 1 ? 'last-child' : ''}`}>
                                            ...
                                            <p className='ffBarlow fs-base fw-normal text-black mb-0 pt-4 mt-2 text-center text-md-start'>{levelsub.paraBox}</p>
                                        </div>
                                    </Col>
                                ))}
                            </Row>
