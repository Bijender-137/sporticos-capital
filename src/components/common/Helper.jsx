    ...
    submap: [
      {
        ...
        description: "Transparency for those we serve",
      },
      {
        aosDelay: "400",
        image: <ArrangeIcon />,
        description: "Integrity with our value-driven approach",
      },
      {
        aosDelay: "600",
        image: <CommunicationIcon />,
        description: "Communication with the utmost respect",
      },
      {
        aosDelay: "800",
        image: <AccountabilityIcon />,
        description: "Accountability through measurable performance",
      },
    ],
  },
  {
