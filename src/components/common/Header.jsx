  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex-grow-1 h-100 d-flex flex-column justify-content-around flex-md-row align-items-center align-items-md-center position-relative z-1 mt-62 mt-sm-69 mt-md-80">
          <CommonHero />
        </div>
      </div>
    </>
