...
const HeroScouting = () => {
    return (
        <>
            <h2 className="px-12 fs-5xl ff-fontspring text-white z-2 position-relative mb-0 text-center text-md-start pt-5 py-md-0 my-md-0">Proudly <span className="d-lg-block"><span className="clr-yellow">Prioritizing</span> Player</span> <span className="d-lg-block">Performance</span></h2>
            <p className="mb-0 px-12 ffBarlow text-white fs-lg pt-2 text-center text-md-start">We believe in the power of well-rounded players both <span className="d-lg-block">on and off the field to support thriving football clubs.</span></p>
            <div className="px-12 d-flex justify-content-center justify-content-md-start position-relative pt-2 pb-md-4 pb-lg-0 z-2">
